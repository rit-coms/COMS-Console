  ...
  "channels": {
    ...
    "leaderboard": {
      ...
      "x-parser-unique-object-id": "leaderboard"
    }
  },
  "operations": {
    "upsert_save_data": {
    ...
    "get_save_data": {
      "action": "send",
      "channel": "$ref:$.channels.save_data",
      "summary": "Retrieve the save data for the current user. This will return a list of JSON objects with the save data.",
      "messages": [
      ...
      "reply": {
        "channel": "$ref:$.channels.save_data",
        "messages": [
          "$ref:$.channels.save_data.messages.save_data_entries"
        ]
      },
      "bindings": {
        "http": {
          ...
          "query": {
            ...
            "properties": {
              "player_slot": {
                "type": "string",
                "description": "The player slot to retrieve save data for. This is the slot number of the player. If not provided, player slot 1 will be used."
              },
              "regex": {
                "type": "string",
              ...
              "file_name": {
                "type": "string",
                "description": "The name of the save data file to retrieve. If not provided, all save data files will be retrieved."
              }
            },
            "additionalProperties": false
          }
    ...
    "insert_leaderboard_entry": {
      "action": "send",
      "channel": "$ref:$.channels.leaderboard",
      "summary": "Create a new leaderboard entry for the current user with the data contained within the request body.  This will create a new leaderboard entry or update an existing one with the same file name. The reply contains the newly created leaderboard entry.",
      "messages": [
      ...
      "reply": {
        "channel": "$ref:$.channels.leaderboard",
        "messages": [
          "$ref:$.channels.leaderboard.messages.leaderboard_entry"
        ]
      },
      "bindings": {
        "http": {
    ...
    "get_leaderboard": {
      "action": "send",
      "channel": "$ref:$.channels.leaderboard",
      "summary": "Retrieve leaderboard data. This will return a list of JSON objects with the leaderboard entries.",
      "messages": [
        "$ref:$.channels.save_data.messages.get"
      ],
      "reply": {
        ...
        "http": {
          ...
          "query": {
            ...
            "properties": {
              "count": {
                "type": "integer",
                "description": "The number of leaderboard entries to retrieve. This will limit the number of entries returned. If not provided, 100 leaderboard entries will be retrieved. 100 is the maximum number of entries that can be retrieved."
              },
              "ascending": {
                "type": "boolean",
                "description": "Whether to sort the leaderboard entries in ascending order. If not provided, descending order will be used."
              },
              "value_name": {
                "type": "string",
                "description": "The name of the leaderboard value to retrieve. This is the title that should be displayed on the leaderboard. If not provided, all leaderboard values will be retrieved."
              },
              "offset": {
                "type": "integer",
                "description": "The offset to start retrieving leaderboard entries from. This will skip the first N entries. If not provided, no offset will be applied."
              },
              "player_slot": {
                "type": "string",
                "description": "The player slot to retrieve leaderboard entries for. This is the slot number of the player. If not provided, global leaderboard entries will be retrieved."
              }
            },
            "additionalProperties": false
          }
      ...
      "x-parser-unique-object-id": "get_leaderboard"
    }
  },
  "components": {
    "messages": {
      "save_data_entry": "$ref:$.channels.save_data.messages.save_data_entry",
      "save_data_entries": "$ref:$.channels.save_data.messages.save_data_entries",
      "new_save_data": "$ref:$.channels.save_data.messages.new_save_data",
      "leaderboard_entry": "$ref:$.channels.leaderboard.messages.leaderboard_entry",
      "leaderboard_entries": {
        ...
        "payload": {
          ...
          "items": {
            ...
            "x-parser-schema-id": "leaderboard_payload_timestamp"
          },
      ...
      "new_leaderboard_entry": "$ref:$.channels.leaderboard.messages.new_leaderboard_entry",
      "get": "$ref:$.channels.save_data.messages.get"
    },
    "schemas": {
      "time_stamp": "$ref:$.channels.save_data.messages.save_data_entry.payload.properties.time_stamp",
      "save_data_payload": "$ref:$.channels.save_data.messages.save_data_entry.payload",
      "leaderboard_payload": "$ref:$.channels.leaderboard.messages.leaderboard_entry.payload",
      "leaderboard_payload_timestamp": "$ref:$.components.messages.leaderboard_entries.payload.items"
    },
    "parameters": {
      "streetlight_id": {
