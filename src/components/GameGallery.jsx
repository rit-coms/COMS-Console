...
function GameGallery() {
  ...
  const searchResults = (games) => {
    if (!hasSearch || search == "") return games;
  ...
  return (
    <div className="game-gallery">
      ...
      <div className="game-gallery-container">
        ...
        {showFullGallery ? (
          <div
            className="game-gallery-back-container"
        ...
        <div
          className={
            showFullGallery ? "game-carousel full-gallery" : "game-carousel"
          }
        >
          {/* {showFullGallery
